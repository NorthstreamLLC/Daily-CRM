/**
 * Daily Gamba CRM - Apps Script automation (v34)
...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem("Repair All Book Formulas (Player ID, Health, Next Action...)", "repairBookRankingFormulas")
    .addSeparator()
...
function repairBookRankingFormulas() {
  ...
  ui.alert("Rebuilt every computed column on all " + BOOK_ROWS + " Book rows:\n\n" +
